from ndpp_cpython import _cc_device_status, \
...
from ndpp_cpython import _cc_scalar_type, \
...
try:
    from ndpp_cpython import _cc_float16
...
from ndpp_cpython import _cc_device_type, _cc_host
class device_type(_cc_device_type):
    pass
host = device_type(_cc_host)
try:
    from ndpp_cpython import _cc_cuda_device, _cc_cuda_pinned, \
...
from ndpp_cpython import _cc_runtime_type, \
...
from ndpp_cpython import _cc_list_push_action, _cc_front, _cc_back
